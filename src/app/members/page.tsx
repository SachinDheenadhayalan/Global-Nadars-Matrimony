    ...
    <div className="container mx-auto px-4 py-12">
      <div className="glass-card p-12">
        ...
        <div className="max-w-2xl mx-auto mb-12">
          <div className="relative">
            <input
              ...
              className="w-full px-6 py-4 rounded-full bg-white/10 border border-white/20 text-white placeholder-gray-400 focus:outline-none focus:border-[#c6c2ff] transition-colors"
            />
          ...
          {members.map((member) => (
            <div key={member.id} className="glass-card p-6 hover:scale-105 transition-transform">
              <div className="flex items-center gap-4 mb-4">
                <div className="w-16 h-16 rounded-full brand-gradient flex items-center justify-center shadow-lg shadow-pink-500/20">
              ...
              <div className="space-y-2 text-gray-300">
                <p className="flex items-center">
                  <svg className="w-5 h-5 mr-2 text-[#c6c2ff]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <button className="w-full mt-4 px-6 py-3 brand-gradient text-white rounded-full font-semibold hover:opacity-95 transition-all shadow-lg shadow-pink-500/20">
                View Profile
              </button>
            </div>
          ))}
        ...
        <div className="mt-12 text-center">
          ...
          <a href="/login" className="inline-block px-8 py-3 brand-gradient text-white rounded-full font-semibold hover:opacity-95 transition-all shadow-lg shadow-pink-500/20">
            Login to View More
          </a>
        </div>
      </div>
